...
export default function Page() {
  ...
  useEffect(() => {
    ...
    const url = "http://26.78.227.119:5065/api/FixTask/NumFixTasks";
    axios
      .get(url, { headers })
  ...
  useEffect(() => {
    ...
    const url = `http://26.78.227.119:5065/api/FixTask/FixTaskPagination?pageNumber=${page}&pageSize=${rowsPerPage}`;
