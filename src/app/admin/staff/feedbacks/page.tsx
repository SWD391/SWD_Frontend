...
export default function Page() {
  ...
  useEffect(() => {
    ...
    const url =
      "http://26.78.227.119:5065/api/Feedbacks/NumFeedbacks";
    axios
      .get(url, { headers })
  ...
  useEffect(() => {
    ...
    const url = `http://26.78.227.119:5065/api/Feedbacks/FeedbackPagination?pageNumber=${page}&pageSize=${rowsPerPage}`;
